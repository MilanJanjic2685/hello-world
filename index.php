  ...
  <body>
	...
	<div class="row clearfix center-block">
        ...
        <form class="form-signin" role="form" action="todo.php" method="POST">
          <h2 class="form-signin-heading text-center text-muted">Prijavite se</h2><br>
        ...
        <button class="btn btn-lg btn-primary btn-block btn-danger" type="submit">Prijavi se</button><br>
